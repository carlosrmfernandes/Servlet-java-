                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">RNE</th>
                                    <th scope="col">Codigo do Protocolo</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><c:out value="${agendamento.nome}" /></td>
                                        <td><c:out value="${agendamento.rne}" /></td>
                                        <td><c:out value="${agendamento.codigo}" /></td>
                                        <td><c:out value="${agendamento.dataAgendamento}" /></td>
                                        <td>
                                            <a class="btn btn-primary" style="border-radius: 30px;" href="agendamentoedit?id=<c:out value='${agendamento.id}' />">Editar</a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <a class="btn btn-danger" id="apagar" style="border-radius: 30px;"href="agendamentodelete?id=<c:out value='${agendamento.id}' />">Apagar</a>                    	
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tr>
