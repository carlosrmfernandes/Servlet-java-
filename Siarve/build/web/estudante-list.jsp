                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><c:out value="${estudante.rne}" /></td>
                                        <td><c:out value="${estudante.passaport}" /></td>
                                        <td><c:out value="${estudante.pais}" /></td>
                                        <td><c:out value="${estudante.endereco_atual}" /></td>
                                        <td><c:out value="${estudante.data_entrada}" /></td>
                                        <td>
                                            <a class="btn btn-primary" style="border-radius: 30px;" href="estudanteedit?id=<c:out value='${estudante.id}' />">Editar</a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <a class="btn btn-danger" style="border-radius: 30px;" href="estudantedelete?id=<c:out value='${estudante.id}' />">Apagar</a>                    	
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tr>
