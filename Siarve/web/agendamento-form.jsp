        ...
        <div class="row">
            ...
            <div class="col-md-4" style="background: #f9f9f9; margin-top: 10px">
                <c:if test="${agendamento != null}">
                    <form action="agendamentoupdate" method="post">
                    </c:if>
                    <c:if test="${agendamento == null}">
                        <form action="agendamentoinsert" method="post">
                        </c:if>
                        <h2>
                            <c:if test="${agendamento != null}">
                            </c:if>
                        ...
                        <c:if test="${agendamento != null}">
                            <input type="hidden" name="id" value="<c:out value='${agendamento.id}' />" />
                        </c:if>   
                        <div class="form-group">
                            <label for="Nome">Nome</label>
                            <input type="text" class="form-control" id="nome" aria-describedby="nome" placeholder="Nome" name="nome" required value="<c:out value='${agendamento.nome}' />">
                        </div>
                        <div class="form-group">
                            <label for="RNE">RNE</label>
                            <input type="text" class="form-control" id="rne" aria-describedby="rne" placeholder="RNE" name="rne" required value="<c:out value='${agendamento.rne}' />">
                        </div>
                        <div class="form-group">
                            <label for="Passaport">Codigo</label>
                            <input type="text" class="form-control" id="codigo" aria-describedby="codigo" placeholder="codigo" required name="codigo" value="<c:out value='${agendamento.codigo}' />">
                        </div>
                        <div class="form-group">
                            <label for="data_agendamento">Data de agendamento</label>
                            <input type="date" class="form-control" id="data_agendamento" aria-describedby="data_agendamento" placeholder="Data de agendamento" name="data_agendamento" required value="<c:out value='${agendamento.dataAgendamento}' />">
                        </div>
